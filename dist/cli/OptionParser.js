...
export class OptionParser {
     ...
     */
    validateSize(size) {
        if (!this.validSizes.includes(String(size).toLowerCase())) {
     ...
     */
    buildDownloaderOptions(options) {
        const downloaderOptions = {
            headless: options.headless,
            debug: options.debug,
            timeout: options.timeout,
            retries: options.retries,
            preferredSize: String(options.size).toLowerCase(),
