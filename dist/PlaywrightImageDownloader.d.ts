import type { ConfigOptions, DownloadResult, LocalManifestResult, DownloadSummary, ImageEntry, ManifestFile } from "./types";
...
export declare class PlaywrightImageDownloader {
     ...
     */
    loadAndProcessManifest(): Promise<{
     ...
     */
    generateReports(results: DownloadResult[], originalManifest: ManifestFile): Promise<LocalManifestResult & {
        totalStorage: number;
        summary: DownloadSummary;
    }>;
    /**
     ...
     */
    getManifestService(): ManifestService;
    /**
...
//# sourceMappingURL=PlaywrightImageDownloader.d.ts.map